...
from toyshop.models import Brand
    ...
    while True:
        ...
        try:
            ...
            if images:
                ...
                image_name = f'{brand.name}.jpg'
                with open(f'media/brand_image/{image_name}', 'wb') as file:
                    file.write(img_response.content)

                brand.image = f'brand_image/{image_name}'
                brand.save()
                print('DONE!!!')
